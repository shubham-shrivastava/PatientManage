...
<link href="assets/bootstrap-datetimepicker/css/datetimepicker.css"
	rel="stylesheet">
<script
...
<link
	href="assets/x-editable/bootstrap3-editable/css/bootstrap-editable.css"
	rel="stylesheet">
<script
	src="assets/x-editable/bootstrap3-editable/js/bootstrap-editable.js"></script>
...
<!-- typeaheadjs -->
<link
	href="assets/x-editable/inputs-ext/typeaheadjs/lib/typeahead.js-bootstrap.css"
	rel="stylesheet">
...
<!-- wysihtml5 -->
<link
	href="assets/x-editable/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.3/bootstrap-wysihtml5-0.0.3.css"
	rel="stylesheet">
<script
	src="assets/x-editable/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.3/wysihtml5-0.3.0.min.js"></script>
<script
	src="assets/x-editable/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.3/bootstrap-wysihtml5-0.0.3.min.js"></script>
...
<!-- address input -->
<link href="assets/x-editable/inputs-ext/address/address.css"
	rel="stylesheet">
...
<body>
	...
	<div style="width: 80%; margin: auto;">
		...
		<form method="get" id="frm" class="form-inline" action="demo.html">
			...
			<label> <span>Form style:</span> <select id="f"
				class="form-control">
			...
			</label> <label style="margin-left: 30px">Mode: <select name="c"
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="#" id="status" data-type="select" data-pk="1"
						data-value="0" data-source="/status" data-title="Select status">Active</a></td>
				</tr>
				...
				<tr>
					...
					<td><a href="#" id="country" data-type="select2" data-pk="1"
						data-value="BS" data-title="Select country"></a></td>
				</tr>
				...
				<tr>
					<td>Wysihtml5 (now support bootstrap 3 !!!). <a href="#"
						id="pencil"><i class="icon-pencil" style="padding-right: 5px"></i>[edit]</a></td>
					<td>
						<div id="note" data-pk="1" data-type="wysihtml5"
							data-toggle="manual" data-title="Enter notes"
							data-placement="top">
							<h3>WYSIWYG</h3>
							WYSIWYG means <i>What You See Is What You Get</i>.<br> But
							may also refer to:
							<ul>
								<li>WYSIWYG (album), a 2000 album by Chumbawamba</li>
								<li>"Whatcha See is Whatcha Get", a 1971 song by The
									Dramatics</li>
								<li>WYSIWYG Film Festival, an annual Christian film
									festival</li>
							</ul>
							<i>Source:</i> <a
								href="http://en.wikipedia.org/wiki/WYSIWYG_%28disambiguation%29">wikipedia.org</a>
		...
		<div style="float: left">
			<h3>
				More examples and tricks <small>(jsFiddle)</small>
			</h3>
			<ul>
				<li><a href="http://jsfiddle.net/xBB5x/38" target="_blank">Submit
						data via PUT method</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/39" target="_blank">Autotext
						option for select</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/40" target="_blank">Display
						checklist as &lt;UL&gt;</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/62" target="_blank">Process
						JSON response</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/63" target="_blank">Editable
						column in table</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/64" target="_blank">MVC
						pattern in editable interface</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/194" target="_blank">Change
						buttons style</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/278" target="_blank">Display
						server response as element's text</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/297" target="_blank">Dependent
						SELECTs</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/331" target="_blank">Single
						regular checkbox</a></li>
				<li><a href="http://jsfiddle.net/xBB5x/329" target="_blank">Live
						events: work with delegated targets</a></li>
				<li><a href="http://jsfiddle.net/wQysh/8" target="_blank">SELECT2
						remote source</a></li>
			</ul>
		</div>
		...
		<footer class="footer" style="clear: both; padding-top: 10px">
			<hr>
			<p>
				<a href="http://vitalets.github.com/x-editable">X-editable</a>
				&copy; Vitaliy Potapov 2012. Released under the MIT license.
			</p>
		</footer>
